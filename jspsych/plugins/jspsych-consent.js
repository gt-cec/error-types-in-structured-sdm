...
jsPsych.plugins.consent = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page(checked=false) {
      var html = trial.pages[current_page];

      // display consent box as checked if it has been clicked
      if (checked){
        var consent_button ='<input type="checkbox" id="consent" value="1" checked>'+'<label>I have read the consent from and I consent to participate in this study</label>';
      } else {
        var consent_button ='<input type="checkbox" id="consent" value="1" unchecked>'+'<label>I have read the consent from and I consent to participate in this study</label>';
      }
      ...
      if (trial.show_clickable_nav) {
        ...
        //nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn'"+
          "style='margin-left: 5px;' "+checked+">&lt; "+trial.button_label_next+
          " &gt;</button></div>";
        var allowed2 = (checked)? '' : "disabled='disabled'";
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn' style='margin-right: 5px;' "+allowed2+">"+trial.button_label_next+
        " &gt;</button></div>";


        html += nav_html;
        display_element.innerHTML = html;
        var checkbox = display_element.querySelector('#consent')
