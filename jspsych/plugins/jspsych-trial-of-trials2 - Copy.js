...
jsPsych.plugins['trial-of-trials2'] = (function () {
    ...
    plugin.gps_questions = [
        {
            prompt: 'How many satellites provide coverage along the landing trajectory?',
    ...
    function load_trial(display_element, trial)
    {
        ...
        gps_image.width = '1000'
        gps_image.height = '500'
        weather_image.src = trial.weather_image;
        weather_image.width = '950',
        weather_image.height = '500',
        angle_image.src = trial.angle_image;
        angle_image.width = '300'
        angle_image.height = '300'
        ...
        {
            gps_question_div1 = makeQuestionDiv(plugin.gps_questions[1]);
            gps_question_div2 = makeQuestionDiv(plugin.gps_questions[0]);
            weather_question_div1 = makeQuestionDiv(plugin.weather_questions[1]);
            ...
            var question_divs = {
                all: [gps_question_div1, gps_question_div2,
                      weather_question_div1, weather_question_div2,
                      angle_question_div1, angle_question_div2],
                gps: [gps_question_div1, gps_question_div2],
                weather: [weather_question_div1, weather_question_div2],
                angle: [angle_question_div1, angle_question_div2],
            }
        ...
        function endTrial(response) {
            ...
            if(trial.enable_questions)
            {
                trial_data['gps_furthest_response'] = gps_question_div1.selectedAnswer.value;
                trial_data['gps_count_response'] = gps_question_div2.selectedAnswer.value;
                trial_data['weather_region_response'] = weather_question_div1.selectedAnswer.value;
                trial_data['weather_path_response'] = weather_question_div2.selectedAnswer.value;
                trial_data['angle_number_response'] = angle_question_div1.selectedAnswer.value;
                trial_data['angle_rating_response'] = angle_question_div2.selectedAnswer.value;
            }
            else
            {
                ['gps_furthest_response', 
                 'gps_count_response',
                 'weather_region_response', 
                 'weather_path_response',
                 'angle_number_response',
